...
export function codeWriterContext(
  ...
  const common = {
    ...
    instruction: "Follow authoritative_rules.content, module_blacklist.value, and dangerous_patterns.value in full; all are loaded directly from the packaged policy files, not summaries.",
    authoritative_rules: {
    ...
    module_blacklist: {
      ...
      loading: "The default deployment snapshot was loaded directly from the packaged policy file; the running service remains authoritative",
    },
  };
